...
export default new Elysia({ prefix: "/flights" })
    .get(
        "/all",
        async () => {
            const data = await db.select().from(flights).execute();
        ...
        { 
            detail: { tags: ["Flights"], description: "Get all planes currently in the air" },
            response: {
                200: t.Array(
                    t.Object({
    ...
    .get(
        ...
        { 
            detail: { tags: ["Flights"], description: "Get all planes currently in the air with minimal data" },
            response: {
                200: t.Array(
                    t.Object({
                        icao24: t.String({ description: "Unique ICAO 24-bit address of the transponder in hex string representation." }),
    ...
    .get("/callsign/:callsign",
        ...
        {
            detail: { tags: ["Flights"], description: "Get flights by callsign" },
            params: t.Object({
